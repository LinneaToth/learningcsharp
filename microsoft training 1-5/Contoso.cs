        ...
        do
        {
            ...
            switch (menuSelection)
            {
                ...
                case "3":
                    ...
                    for (int i = 0; i < maxPets; i++)
                    {
                        if (ourAnimals[i, 0] == "ID #: noId") continue;

                        string ageValue = ourAnimals[i, 2].Replace("Age: ", "");
                        if (!int.TryParse(ageValue, out _))
                        {
                            bool properAge = false;
                            do
                            {
                                Console.WriteLine($"Please enter a proper age for {ourAnimals[i, 0]}:");
                                readResult = Console.ReadLine();
